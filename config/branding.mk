...
# Custom Versioning
ETERNITY_VERSION := EternityOS-$(EternityOS_BASE_VERSION)-$(Eternity_CODENAME)-$(CUSTOM_BUILD)-$(CUSTOM_PLATFORM_VERSION)-$(CUSTOM_BUILD_DATE)-$(CUSTOM_BUILD_TYPE)
